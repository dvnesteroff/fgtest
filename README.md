...
![workflow](https://github.com/dvnesteroff/foodgram-project-react/actions/workflows/foodgram_workflow.yml/badge.svg)
...
```bash
git clone https://github.com/dvnesteroff/foodgram-project-react.git
```
